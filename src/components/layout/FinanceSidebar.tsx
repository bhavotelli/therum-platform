    ...
    <Link 
      ...
      className={`flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-colors ${
        isActive 
          ...
          : 'text-zinc-600 hover:text-teal-900 hover:bg-teal-50/50'
      }`}
    >
      {icon}
      {children}
  ...
  return (
    <aside className="fixed inset-y-0 left-0 w-64 bg-zinc-50 border-r border-teal-100 flex flex-col">
      ...
      <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        <NavLink href="/finance/dashboard" icon={Icons.Dashboard}>Dashboard</NavLink>
        <NavLink href="/finance/deals" icon={Icons.Queue}>Deals (Read-only)</NavLink>
        <NavLink href="/finance/invoices" icon={Icons.Queue}>Invoice Queue</NavLink>
        <NavLink href="/finance/credit-notes" icon={Icons.CreditNotes}>Credit Notes</NavLink>
        <NavLink href="/finance/overdue" icon={Icons.Overdue}>Overdue</NavLink>
        <NavLink href="/finance/expenses" icon={Icons.Expenses}>Expense Approvals</NavLink>
        <NavLink href="/finance/payouts" icon={Icons.Payouts}>Payout Centre</NavLink>
        <NavLink href="/finance/vat-compliance" icon={Icons.VAT}>VAT Compliance</NavLink>
        <NavLink href="/finance/xero-sync" icon={Icons.Sync}>Xero Sync</NavLink>
        <NavLink href="/finance/settings" icon={Icons.Settings}>Settings</NavLink>
      </nav>

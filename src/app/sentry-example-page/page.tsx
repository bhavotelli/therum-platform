      ...
      <main>
        ...
        <p className="description">
          ...
          <a
            target="_blank"
            rel="noopener"
            href="https://therum-technologies-ltd.sentry.io/issues/?project=4511246084800592"
          >
            Issues Page
          </a>
        ...
        <button
          type="button"
          onClick={() => {
            Sentry.logger.info("Triggering ReferenceError: myUndefinedFunction is not defined");

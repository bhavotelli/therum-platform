              ...
              <div className="flex items-center gap-3 flex-shrink-0">
                {isXeroConnected ? (
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white text-sm font-semibold shadow-sm hover:shadow-md transition-all duration-150"
                  >
        ...
        <section className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
          <div className="p-8">
            ...
            <form action={updateDealNumberPrefix} className="flex items-end gap-4">
              <div className="flex-1 max-w-xs">
                ...
                <input
                  ...
                  type="text"
                  defaultValue={agency.dealNumberPrefix ?? ''}
                  maxLength={4}
                  placeholder="e.g. TH"
                ...
                />
                <p className="mt-1.5 text-[11px] text-gray-400">2–4 uppercase letters. Must be unique across all agencies.</p>
              </div>
              <button
                type="submit"
            ...
            {agency.dealNumberPrefix && (
              <div className="mt-4 flex items-center gap-2 px-4 py-3 rounded-xl bg-indigo-50 border border-indigo-100">
                ...
                <span className="text-xs text-indigo-700 font-medium">
                  Active prefix: <span className="font-mono font-bold">{agency.dealNumberPrefix}</span> — new deals will be numbered <span className="font-mono font-bold">{agency.dealNumberPrefix}-0001</span>, <span className="font-mono font-bold">{agency.dealNumberPrefix}-0002</span>, etc.
                </span>
              </div>
            )}
          </div>
